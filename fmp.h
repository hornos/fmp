...
#define FMP_END               endif

#define FMP_MPI_BARRIER(COM,IERR) call mpi_barrier(COM,IERR)
...
#define FMP_GPU_SUCCESS(IERR) if(IERR.eq.CUDA_SUCCESS)
#define FMP_GPU_FAILED(IERR)  if(IERR.ne.CUDA_SUCCESS)
